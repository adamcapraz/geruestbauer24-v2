...
import {
  LayoutDashboard, MessageSquare, Settings, Search,
...
const navItems = [
  { href: "/kunde/dashboard", label: "Übersicht", icon: LayoutDashboard },
  { href: "/kunde/dashboard/anfragen", label: "Meine Anfragen", icon: MessageSquare },
  { href: "/kunde/dashboard/einstellungen", label: "Einstellungen", icon: Settings },
]

export default function KundeDashboardLayout({ children }: { children: React.ReactNode }) {
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-medium text-blue-400">Kundenkonto</span>
                </div>
        ...
        <main className="flex-1 min-w-0">
          <div className="md:hidden flex items-center gap-3 p-4 border-b">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm">Kunde Dashboard</span>
            </div>
          </div>
